        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'price',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.00'), max_digits=20, verbose_name='price'
                    ),
                ),
                (
                    'content_type',
                    models.CharField(
                        choices=[('free', 'Free'), ('paid', 'Paid')], max_length=4, verbose_name='content type'
                    ),
                ),
                (
                    'creator',
                ...
                ('purchases', models.ManyToManyField(related_name='purchased_contents', to='creators.creator')),
            ],
            options={
                'abstract': False,
            },
